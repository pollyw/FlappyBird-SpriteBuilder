...
@implementation MainScene {
    ...
    //how objects move in terms of normal layer (1,1) = (x,y)
    //we are only changing x because only moving horizontally
    CGPoint _cloudParallaxRatio;
    
    //bushes should be moving faster because they are closer
    //they should have a higher x value than clouds
...
- (void)didLoadFromCCB {
    ...
    //spritebuilder does not have parallax mode, therefore we need to manually take each cloud and bush and switch them to be children of the ccparalax node
...
- (void)update:(CCTime)delta
{
    ...
    for (CCNode *bush in _bushes) {
        ...
        //get the screen positiong of the bush
    ...
    //loop the clouds
    for (CCNode *cloud in _clouds) {
        //get the world positiong of the cloud
